...
python -m Downloader.search --out "./Data/RAW/SM/" --max_res $MAX_PRODS --wkt 'POLYGON((-16.6346 22.2274,54.5568 22.2274,54.5568 61.0792,-16.6346 61.0792,-16.6346 22.2274))' --download_all